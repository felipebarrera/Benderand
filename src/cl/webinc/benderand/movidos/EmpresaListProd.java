...
public class EmpresaListProd extends ListActivity {
    private static final String TAG = "ListaEmpresas";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_ProgressDialog = ProgressDialog.show(EmpresaListProd.this,    
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(EmpresaListProd.this, "ID '" + o.get("id_empre") + "' was clicked.", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(EmpresaListProd.this, ProductoListProd.class);
                intent.putExtra("id", o.get("id_empre"));
                Log.e("empresalist ", " set extra " + o.get("id_empre"));
                extra.put("id", o.get("id_empre"));
                app.setExtra(extra);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.addIntentOptions(Menu.CATEGORY_ALTERNATIVE, 0, 0,
                new ComponentName(this, EmpresaListProd.class), null, intent, 0, null);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case MENU_ITEM_INSERT:
        	...
        	Intent i = new Intent(this, EmpresaEditor.class);
            extra.put("id", "0");
            app.setExtra(extra);
            startActivity(i);
            return true;
    ...
    private class sincTask extends AsyncTask<String, Void, ArrayList<HashMap<String, String>>>  
    {
    	@Override
    	 protected void onPostExecute(ArrayList<HashMap<String, String>> result) {
    		if(result != null) {
    	        ListAdapter adapter = new SimpleAdapter(EmpresaListProd.this, result, R.layout.listitem,
    	                new String[] { empresa.rut_empresa, empresa.nombre_empresa }, new int[] { android.R.id.text1, android.R.id.text2 });
    	...
    	protected ArrayList<HashMap<String, String>> doInBackground(
    		...
    		Log.e("thread end", " thread end");
             try {
    			mylist = WebConector.getJSONfromURL("http://"+ app.getUrl() +"/index.php/androidtienda/get_empresa/", "empresa");
