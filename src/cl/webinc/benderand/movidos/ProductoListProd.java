...
public class ProductoListProd extends ListActivity {
    private static final String TAG = "hello productolist";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_ProgressDialog = ProgressDialog.show(ProductoListProd.this,    
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(ProductoListProd.this, "ID '" + o.get("id_prod") + "' was clicked.", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(ProductoListProd.this, Productoeditor.class);
                intent.putExtra("id", o.get("id_prod"));
                extra.put("id", o.get("id_prod"));
                app.setExtra(extra);
                Log.e(TAG, "" + app.getExtra().get("id_prod"));
    ...
    protected void onResume() {
        ...
        new sincTask().execute();
		Log.e("onResume", "onResume");
        m_ProgressDialog = ProgressDialog.show(ProductoList.this,    
                "Please wait...", "Retrieving data ...", true);
    }*/
	@Override
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.addIntentOptions(Menu.CATEGORY_ALTERNATIVE, 0, 0,
                new ComponentName(this, ProductoListProd.class), null, intent, 0, null);
    ...
    private class sincTask extends AsyncTask<String, Void, ArrayList<HashMap<String, String>>>  
    {
    	@Override
    	 protected void onPostExecute(ArrayList<HashMap<String, String>> result) {
    		if(result != null) {
    	        ListAdapter adapter = new SimpleAdapter(ProductoListProd.this, result, R.layout.listitem,
