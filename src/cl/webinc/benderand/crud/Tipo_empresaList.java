...
import cl.webinc.benderand.provider.Base.tipo_empresa;
...
public class Tipo_empresaList extends ListActivity {
    private static final String TAG = "tipo_empresalist";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("tipo_empresalist", "onCreate");
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Tipo_empresaList.this, Tipo_empresaEditor.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.addIntentOptions(Menu.CATEGORY_ALTERNATIVE, 0, 0,
                new ComponentName(this, Tipo_empresaList.class), null, intent, 0, null);
    ...
    private class sincTask extends AsyncTask<String, Void, ArrayList<HashMap<String, String>>>  
    {
        ...
        protected void onPreExecute() {
            dialog = new ProgressDialog(Tipo_empresaList.this);
        ...
        @Override
         protected void onPostExecute(ArrayList<HashMap<String, String>> result) {
            if(result != null) {
                ListAdapter adapter = new SimpleAdapter(Tipo_empresaList.this, result, R.layout.listitem,
                        new String[] { tipo_empresa.id_tipo_empresa, tipo_empresa.id_tipo_empresa }, new int[] { android.R.id.text1, android.R.id.text2 });
                setListAdapter(adapter);
                }else {
                    Toast.makeText(getApplicationContext(), "Fallo la sincronizacion", Toast.LENGTH_SHORT).show();
                    Log.e("sinctask tipo_empresalista", " Fallo la sincronizacion");
                }
                dialog.dismiss();
         }
        @Override
        protected ArrayList<HashMap<String, String>> doInBackground(
            ...
            if(!app.isExternal()){
                ...
                Cursor cursor = getContentResolver().query(tipo_empresa.CONTENT_URI, ProjectionCreater.pctipo_empresa, null, null, tipo_empresa.DEFAULT_ORDEN);
                CursortoArrayhash ctah = CursortoArrayhash.getinstance();
                mylist = ctah.ahTipo_empresa(cursor);
            }
            else
            {
                if(app.isOnline(Tipo_empresaList.this))
                {
                    try {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case MENU_ITEM_INSERT:
            Intent i = new Intent(this, Tipo_empresaEditor.class);
            extra.put("id", "0");
            app.setExtra(extra);
