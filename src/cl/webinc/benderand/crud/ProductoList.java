    ...
    private class sincTask extends AsyncTask<String, Void, ArrayList<HashMap<String, String>>>  
    {
        ...
        @Override
         protected void onPostExecute(ArrayList<HashMap<String, String>> result) {
            if(result != null) {
                ListAdapter adapter = new SimpleAdapter(ProductoList.this, result, R.layout.listitem,
                        new String[] { producto.id_producto, producto.id_producto }, new int[] { android.R.id.text1, android.R.id.text2 });
        ...
        protected ArrayList<HashMap<String, String>> doInBackground(
            ...
            if(!app.isExternal()){
                ...
                Cursor cursor = getContentResolver().query(producto.CONTENT_URI, ProjectionCreater.pcproducto, null, null, producto.DEFAULT_ORDEN);
                CursortoArrayhash ctah = CursortoArrayhash.getinstance();
                mylist = ctah.ahProducto(cursor);
            }
            else
            {
