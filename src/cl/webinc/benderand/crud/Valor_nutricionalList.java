...
public class Valor_nutricionalList extends ListActivity {
    private static final String TAG = "valor_nutricionallist";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("valor_nutricionallist", "onCreate");
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Valor_nutricionalList.this, Valor_nutricionalEditor.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.addIntentOptions(Menu.CATEGORY_ALTERNATIVE, 0, 0,
                new ComponentName(this, Valor_nutricionalList.class), null, intent, 0, null);
    ...
    private class sincTask extends AsyncTask<String, Void, ArrayList<HashMap<String, String>>>  
    {
        ...
        protected void onPreExecute() {
            dialog = new ProgressDialog(Valor_nutricionalList.this);
        ...
        @Override
         protected void onPostExecute(ArrayList<HashMap<String, String>> result) {
            if(result != null) {
                ListAdapter adapter = new SimpleAdapter(Valor_nutricionalList.this, result, R.layout.listitem,
                        new String[] { valor_nutricional.id_valor_nutricional, valor_nutricional.id_valor_nutricional }, new int[] { android.R.id.text1, android.R.id.text2 });
                setListAdapter(adapter);
                }else {
                    Toast.makeText(getApplicationContext(), "Fallo la sincronizacion", Toast.LENGTH_SHORT).show();
                    Log.e("sinctask valor_nutricionallista", " Fallo la sincronizacion");
                }
                dialog.dismiss();
         }
        @Override
        protected ArrayList<HashMap<String, String>> doInBackground(
            ...
            if(!app.isExternal()){
                ...
                Cursor cursor = getContentResolver().query(valor_nutricional.CONTENT_URI, ProjectionCreater.pcvalor_nutricional, null, null, valor_nutricional.DEFAULT_ORDEN);
                CursortoArrayhash ctah = CursortoArrayhash.getinstance();
                mylist = ctah.ahValor_nutricional(cursor);
            }
            else
            {
                if(app.isOnline(Valor_nutricionalList.this))
                {
                    try {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case MENU_ITEM_INSERT:
            Intent i = new Intent(this, Valor_nutricionalEditor.class);
            extra.put("id", "0");
            app.setExtra(extra);
