...
public class Carne_empresaList extends ListActivity {
    private static final String TAG = "carne_empresalist";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("carne_empresalist", "onCreate");
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Carne_empresaList.this, Carne_empresaEditor.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.addIntentOptions(Menu.CATEGORY_ALTERNATIVE, 0, 0,
                new ComponentName(this, Carne_empresaList.class), null, intent, 0, null);
    ...
    private class sincTask extends AsyncTask<String, Void, ArrayList<HashMap<String, String>>>  
    {
        ...
        protected void onPreExecute() {
            dialog = new ProgressDialog(Carne_empresaList.this);
        ...
        @Override
         protected void onPostExecute(ArrayList<HashMap<String, String>> result) {
            if(result != null) {
                ListAdapter adapter = new SimpleAdapter(Carne_empresaList.this, result, R.layout.listitem,
                        new String[] { carne_empresa.id_carne_empresa, carne_empresa.id_carne_empresa }, new int[] { android.R.id.text1, android.R.id.text2 });
                setListAdapter(adapter);
                }else {
                    Toast.makeText(getApplicationContext(), "Fallo la sincronizacion", Toast.LENGTH_SHORT).show();
                    Log.e("sinctask carne_empresalista", " Fallo la sincronizacion");
                }
                dialog.dismiss();
         }
        @Override
        protected ArrayList<HashMap<String, String>> doInBackground(
            ...
            if(!app.isExternal()){
                ...
                Cursor cursor = getContentResolver().query(carne_empresa.CONTENT_URI, ProjectionCreater.pccarne_empresa, null, null, carne_empresa.DEFAULT_ORDEN);
                CursortoArrayhash ctah = CursortoArrayhash.getinstance();
                mylist = ctah.ahCarne_empresa(cursor);
            }
            else
            {
                if(app.isOnline(Carne_empresaList.this))
                {
                    try {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case MENU_ITEM_INSERT:
            Intent i = new Intent(this, Carne_empresaEditor.class);
            extra.put("id", "0");
            app.setExtra(extra);
