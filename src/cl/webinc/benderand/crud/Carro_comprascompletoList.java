...
public class Carro_comprascompletoList extends ListActivity {
    private static final String TAG = "carro_comprascompletolist";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("carro_comprascompletolist", "onCreate");
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Carro_comprascompletoList.this, Carro_comprascompletoEditor.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.addIntentOptions(Menu.CATEGORY_ALTERNATIVE, 0, 0,
                new ComponentName(this, Carro_comprascompletoList.class), null, intent, 0, null);
    ...
    private class sincTask extends AsyncTask<String, Void, ArrayList<HashMap<String, String>>>  
    {
        ...
        protected void onPreExecute() {
            dialog = new ProgressDialog(Carro_comprascompletoList.this);
        ...
        @Override
         protected void onPostExecute(ArrayList<HashMap<String, String>> result) {
            if(result != null) {
                ListAdapter adapter = new SimpleAdapter(Carro_comprascompletoList.this, result, R.layout.listitem,
                        new String[] { carro_comprascompleto.id_carro_compras, carro_comprascompleto.id_carro_compras }, new int[] { android.R.id.text1, android.R.id.text2 });
                setListAdapter(adapter);
                }else {
                    Toast.makeText(getApplicationContext(), "Fallo la sincronizacion", Toast.LENGTH_SHORT).show();
                    Log.e("sinctask carro_comprascompletolista", " Fallo la sincronizacion");
                }
                dialog.dismiss();
         }
        @Override
        protected ArrayList<HashMap<String, String>> doInBackground(
            ...
            if(!app.isExternal()){
                ...
                Cursor cursor = getContentResolver().query(carro_comprascompleto.CONTENT_URI, ProjectionCreater.pccarro_comprascompleto, null, null, carro_comprascompleto.DEFAULT_ORDEN);
                CursortoArrayhash ctah = CursortoArrayhash.getinstance();
                mylist = ctah.ahCarro_comprascompleto(cursor);
            }
            else
            {
                if(app.isOnline(Carro_comprascompletoList.this))
                {
                    try {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case MENU_ITEM_INSERT:
            Intent i = new Intent(this, Carro_comprascompletoEditor.class);
            extra.put("id", "0");
            app.setExtra(extra);
