...
public class Tipo_productoList extends ListActivity {
    private static final String TAG = "tipo_productolist";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("tipo_productolist", "onCreate");
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Tipo_productoList.this, Tipo_productoEditor.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.addIntentOptions(Menu.CATEGORY_ALTERNATIVE, 0, 0,
                new ComponentName(this, Tipo_productoList.class), null, intent, 0, null);
    ...
    private class sincTask extends AsyncTask<String, Void, ArrayList<HashMap<String, String>>>  
    {
        ...
        protected void onPreExecute() {
            dialog = new ProgressDialog(Tipo_productoList.this);
        ...
        @Override
         protected void onPostExecute(ArrayList<HashMap<String, String>> result) {
            if(result != null) {
                ListAdapter adapter = new SimpleAdapter(Tipo_productoList.this, result, R.layout.listitem,
                        new String[] { tipo_producto.id_tipo_producto, tipo_producto.id_tipo_producto }, new int[] { android.R.id.text1, android.R.id.text2 });
                setListAdapter(adapter);
                }else {
                    Toast.makeText(getApplicationContext(), "Fallo la sincronizacion", Toast.LENGTH_SHORT).show();
                    Log.e("sinctask tipo_productolista", " Fallo la sincronizacion");
                }
                dialog.dismiss();
         }
        @Override
        protected ArrayList<HashMap<String, String>> doInBackground(
            ...
            if(!app.isExternal()){
                ...
                Cursor cursor = getContentResolver().query(tipo_producto.CONTENT_URI, ProjectionCreater.pctipo_producto, null, null, tipo_producto.DEFAULT_ORDEN);
                CursortoArrayhash ctah = CursortoArrayhash.getinstance();
                mylist = ctah.ahTipo_producto(cursor);
            }
            else
            {
                if(app.isOnline(Tipo_productoList.this))
                {
                    try {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case MENU_ITEM_INSERT:
            Intent i = new Intent(this, Tipo_productoEditor.class);
            extra.put("id", "0");
            app.setExtra(extra);
