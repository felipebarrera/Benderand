...
import cl.webinc.benderand.provider.Base.cliente_empresa;
...
public class Cliente_empresaList extends ListActivity {
    private static final String TAG = "cliente_empresalist";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("cliente_empresalist", "onCreate");
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Cliente_empresaList.this, Cliente_empresaEditor.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.addIntentOptions(Menu.CATEGORY_ALTERNATIVE, 0, 0,
                new ComponentName(this, Cliente_empresaList.class), null, intent, 0, null);
    ...
    private class sincTask extends AsyncTask<String, Void, ArrayList<HashMap<String, String>>>  
    {
        ...
        protected void onPreExecute() {
            dialog = new ProgressDialog(Cliente_empresaList.this);
        ...
        @Override
         protected void onPostExecute(ArrayList<HashMap<String, String>> result) {
            if(result != null) {
                ListAdapter adapter = new SimpleAdapter(Cliente_empresaList.this, result, R.layout.listitem,
                        new String[] { cliente_empresa.id_cliente_empresa, cliente_empresa.id_cliente_empresa }, new int[] { android.R.id.text1, android.R.id.text2 });
                setListAdapter(adapter);
                }else {
                    Toast.makeText(getApplicationContext(), "Fallo la sincronizacion", Toast.LENGTH_SHORT).show();
                    Log.e("sinctask cliente_empresalista", " Fallo la sincronizacion");
                }
                dialog.dismiss();
         }
        @Override
        protected ArrayList<HashMap<String, String>> doInBackground(
            ...
            if(!app.isExternal()){
                ...
                Cursor cursor = getContentResolver().query(cliente_empresa.CONTENT_URI, ProjectionCreater.pccliente_empresa, null, null, cliente_empresa.DEFAULT_ORDEN);
                CursortoArrayhash ctah = CursortoArrayhash.getinstance();
                mylist = ctah.ahCliente_empresa(cursor);
            }
            else
            {
                if(app.isOnline(Cliente_empresaList.this))
                {
                    try {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case MENU_ITEM_INSERT:
            Intent i = new Intent(this, Cliente_empresaEditor.class);
            extra.put("id", "0");
            app.setExtra(extra);
