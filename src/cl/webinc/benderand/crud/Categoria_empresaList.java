...
import cl.webinc.benderand.provider.Base.categoria_empresa;
...
public class Categoria_empresaList extends ListActivity {
    private static final String TAG = "categoria_empresalist";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("categoria_empresalist", "onCreate");
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Categoria_empresaList.this, Categoria_empresaEditor.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.addIntentOptions(Menu.CATEGORY_ALTERNATIVE, 0, 0,
                new ComponentName(this, Categoria_empresaList.class), null, intent, 0, null);
    ...
    private class sincTask extends AsyncTask<String, Void, ArrayList<HashMap<String, String>>>  
    {
        ...
        protected void onPreExecute() {
            dialog = new ProgressDialog(Categoria_empresaList.this);
        ...
        @Override
         protected void onPostExecute(ArrayList<HashMap<String, String>> result) {
            if(result != null) {
                ListAdapter adapter = new SimpleAdapter(Categoria_empresaList.this, result, R.layout.listitem,
                        new String[] { categoria_empresa.id_categoria_empresa, categoria_empresa.id_categoria_empresa }, new int[] { android.R.id.text1, android.R.id.text2 });
                setListAdapter(adapter);
                }else {
                    Toast.makeText(getApplicationContext(), "Fallo la sincronizacion", Toast.LENGTH_SHORT).show();
                    Log.e("sinctask categoria_empresalista", " Fallo la sincronizacion");
                }
                dialog.dismiss();
         }
        @Override
        protected ArrayList<HashMap<String, String>> doInBackground(
            ...
            if(!app.isExternal()){
                ...
                Cursor cursor = getContentResolver().query(categoria_empresa.CONTENT_URI, ProjectionCreater.pccategoria_empresa, null, null, categoria_empresa.DEFAULT_ORDEN);
                CursortoArrayhash ctah = CursortoArrayhash.getinstance();
                mylist = ctah.ahCategoria_empresa(cursor);
            }
            else
            {
                if(app.isOnline(Categoria_empresaList.this))
                {
                    try {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case MENU_ITEM_INSERT:
            Intent i = new Intent(this, Categoria_empresaEditor.class);
            extra.put("id", "0");
            app.setExtra(extra);
