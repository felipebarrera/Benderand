...
public class Familia_necesidadList extends ListActivity {
    private static final String TAG = "familia_necesidadlist";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("familia_necesidadlist", "onCreate");
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Familia_necesidadList.this, Familia_necesidadEditor.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.addIntentOptions(Menu.CATEGORY_ALTERNATIVE, 0, 0,
                new ComponentName(this, Familia_necesidadList.class), null, intent, 0, null);
    ...
    private class sincTask extends AsyncTask<String, Void, ArrayList<HashMap<String, String>>>  
    {
        ...
        protected void onPreExecute() {
            dialog = new ProgressDialog(Familia_necesidadList.this);
        ...
        @Override
         protected void onPostExecute(ArrayList<HashMap<String, String>> result) {
            if(result != null) {
                ListAdapter adapter = new SimpleAdapter(Familia_necesidadList.this, result, R.layout.listitem,
                        new String[] { familia_necesidad.id_familia_necesidad, familia_necesidad.id_familia_necesidad }, new int[] { android.R.id.text1, android.R.id.text2 });
                setListAdapter(adapter);
                }else {
                    Toast.makeText(getApplicationContext(), "Fallo la sincronizacion", Toast.LENGTH_SHORT).show();
                    Log.e("sinctask familia_necesidadlista", " Fallo la sincronizacion");
                }
                dialog.dismiss();
         }
        @Override
        protected ArrayList<HashMap<String, String>> doInBackground(
            ...
            if(!app.isExternal()){
                ...
                Cursor cursor = getContentResolver().query(familia_necesidad.CONTENT_URI, ProjectionCreater.pcfamilia_necesidad, null, null, familia_necesidad.DEFAULT_ORDEN);
                CursortoArrayhash ctah = CursortoArrayhash.getinstance();
                mylist = ctah.ahFamilia_necesidad(cursor);
            }
            else
            {
                if(app.isOnline(Familia_necesidadList.this))
                {
                    try {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case MENU_ITEM_INSERT:
            Intent i = new Intent(this, Familia_necesidadEditor.class);
            extra.put("id", "0");
            app.setExtra(extra);
