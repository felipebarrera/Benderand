...
public class Contenido_unidad_medidaList extends ListActivity {
    private static final String TAG = "contenido_unidad_medidalist";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("contenido_unidad_medidalist", "onCreate");
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Contenido_unidad_medidaList.this, Contenido_unidad_medidaEditor.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.addIntentOptions(Menu.CATEGORY_ALTERNATIVE, 0, 0,
                new ComponentName(this, Contenido_unidad_medidaList.class), null, intent, 0, null);
    ...
    private class sincTask extends AsyncTask<String, Void, ArrayList<HashMap<String, String>>>  
    {
        ...
        protected void onPreExecute() {
            dialog = new ProgressDialog(Contenido_unidad_medidaList.this);
        ...
        @Override
         protected void onPostExecute(ArrayList<HashMap<String, String>> result) {
            if(result != null) {
                ListAdapter adapter = new SimpleAdapter(Contenido_unidad_medidaList.this, result, R.layout.listitem,
                        new String[] { contenido_unidad_medida.id_contenido_unidad_medida, contenido_unidad_medida.id_contenido_unidad_medida }, new int[] { android.R.id.text1, android.R.id.text2 });
                setListAdapter(adapter);
                }else {
                    Toast.makeText(getApplicationContext(), "Fallo la sincronizacion", Toast.LENGTH_SHORT).show();
                    Log.e("sinctask contenido_unidad_medidalista", " Fallo la sincronizacion");
                }
                dialog.dismiss();
         }
        @Override
        protected ArrayList<HashMap<String, String>> doInBackground(
            ...
            if(!app.isExternal()){
                ...
                Cursor cursor = getContentResolver().query(contenido_unidad_medida.CONTENT_URI, ProjectionCreater.pccontenido_unidad_medida, null, null, contenido_unidad_medida.DEFAULT_ORDEN);
                CursortoArrayhash ctah = CursortoArrayhash.getinstance();
                mylist = ctah.ahContenido_unidad_medida(cursor);
            }
            else
            {
                if(app.isOnline(Contenido_unidad_medidaList.this))
                {
                    try {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case MENU_ITEM_INSERT:
            Intent i = new Intent(this, Contenido_unidad_medidaEditor.class);
            extra.put("id", "0");
            app.setExtra(extra);
