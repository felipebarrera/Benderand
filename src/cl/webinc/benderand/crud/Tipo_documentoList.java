...
public class Tipo_documentoList extends ListActivity {
    private static final String TAG = "tipo_documentolist";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("tipo_documentolist", "onCreate");
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Tipo_documentoList.this, Tipo_documentoEditor.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.addIntentOptions(Menu.CATEGORY_ALTERNATIVE, 0, 0,
                new ComponentName(this, Tipo_documentoList.class), null, intent, 0, null);
    ...
    private class sincTask extends AsyncTask<String, Void, ArrayList<HashMap<String, String>>>  
    {
        ...
        protected void onPreExecute() {
            dialog = new ProgressDialog(Tipo_documentoList.this);
        ...
        @Override
         protected void onPostExecute(ArrayList<HashMap<String, String>> result) {
            if(result != null) {
                ListAdapter adapter = new SimpleAdapter(Tipo_documentoList.this, result, R.layout.listitem,
                        new String[] { tipo_documento.id_tipo_documento, tipo_documento.id_tipo_documento }, new int[] { android.R.id.text1, android.R.id.text2 });
                setListAdapter(adapter);
                }else {
                    Toast.makeText(getApplicationContext(), "Fallo la sincronizacion", Toast.LENGTH_SHORT).show();
                    Log.e("sinctask tipo_documentolista", " Fallo la sincronizacion");
                }
                dialog.dismiss();
         }
        @Override
        protected ArrayList<HashMap<String, String>> doInBackground(
            ...
            if(!app.isExternal()){
                ...
                Cursor cursor = getContentResolver().query(tipo_documento.CONTENT_URI, ProjectionCreater.pctipo_documento, null, null, tipo_documento.DEFAULT_ORDEN);
                CursortoArrayhash ctah = CursortoArrayhash.getinstance();
                mylist = ctah.ahTipo_documento(cursor);
            }
            else
            {
                if(app.isOnline(Tipo_documentoList.this))
                {
                    try {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case MENU_ITEM_INSERT:
            Intent i = new Intent(this, Tipo_documentoEditor.class);
            extra.put("id", "0");
            app.setExtra(extra);
