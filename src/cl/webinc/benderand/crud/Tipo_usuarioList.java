...
import cl.webinc.benderand.provider.Base.tipo_usuario;
...
public class Tipo_usuarioList extends ListActivity {
    private static final String TAG = "tipo_usuariolist";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("tipo_usuariolist", "onCreate");
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Tipo_usuarioList.this, Tipo_usuarioEditor.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.addIntentOptions(Menu.CATEGORY_ALTERNATIVE, 0, 0,
                new ComponentName(this, Tipo_usuarioList.class), null, intent, 0, null);
    ...
    private class sincTask extends AsyncTask<String, Void, ArrayList<HashMap<String, String>>>  
    {
        ...
        protected void onPreExecute() {
            dialog = new ProgressDialog(Tipo_usuarioList.this);
        ...
        @Override
         protected void onPostExecute(ArrayList<HashMap<String, String>> result) {
            if(result != null) {
                ListAdapter adapter = new SimpleAdapter(Tipo_usuarioList.this, result, R.layout.listitem,
                        new String[] { tipo_usuario.id_tipo_usuario, tipo_usuario.id_tipo_usuario }, new int[] { android.R.id.text1, android.R.id.text2 });
                setListAdapter(adapter);
                }else {
                    Toast.makeText(getApplicationContext(), "Fallo la sincronizacion", Toast.LENGTH_SHORT).show();
                    Log.e("sinctask tipo_usuariolista", " Fallo la sincronizacion");
                }
                dialog.dismiss();
         }
        @Override
        protected ArrayList<HashMap<String, String>> doInBackground(
            ...
            if(!app.isExternal()){
                ...
                Cursor cursor = getContentResolver().query(tipo_usuario.CONTENT_URI, ProjectionCreater.pctipo_usuario, null, null, tipo_usuario.DEFAULT_ORDEN);
                CursortoArrayhash ctah = CursortoArrayhash.getinstance();
                mylist = ctah.ahTipo_usuario(cursor);
            }
            else
            {
                if(app.isOnline(Tipo_usuarioList.this))
                {
                    try {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case MENU_ITEM_INSERT:
            Intent i = new Intent(this, Tipo_usuarioEditor.class);
            extra.put("id", "0");
            app.setExtra(extra);
