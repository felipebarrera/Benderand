...
import cl.webinc.benderand.entidad.Item_facturacompleto;

public class CustomAdapterDetalleCompra extends BaseAdapter implements OnClickListener {
    /*********** Declare Used Variables *********/
    private Activity activity;
    private ArrayList data;
    private static LayoutInflater inflater=null;
    Item_facturacompleto tempValues=null;
    /*************  cadapter Constructor *****************/
    public CustomAdapterDetalleCompra(Activity a, ArrayList d) {
        /********** Take passed values **********/
        activity = a;
        data=d;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        else
        {
            ...
            tempValues=null;
            tempValues = ( Item_facturacompleto ) data.get( position );
            /************  Set Model values in Holder elements ***********/
            holder.text1.setText( tempValues.getCantidad());
            holder.text2.setText( tempValues.getDescripcion_producto());
            double cant = Double.valueOf(tempValues.getCantidad());
            double br = Double.valueOf(tempValues.getPrecio());
